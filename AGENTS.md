...
- Preserve the approved palette: navbar and footer `#722F37`, primary buttons and accents `#722F37`, button hover `#5F252D`, page background `#F7F3EF`, and headings `#3A2232`.
