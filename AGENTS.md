...
- **Typography:** DM Serif Display for editorial headings; Plus Jakarta Sans for body and UI
- **Deployment:** Vercel
...
- Preserve the warm brand palette: coral `#ED7772`, ivory cream `#F7F3EF`, cocoa text `#432719`, dark cocoa `#321D16`, white `#FFFDF9`, and blush `#FBE9E5`.
