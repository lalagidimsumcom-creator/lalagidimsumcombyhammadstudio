# LalaGi Dimsum — Website Guidelines

## Project Overview

Official brand website and high-converting landing page for **LalaGi Dimsum** in Jagakarsa, South Jakarta.
...
- **Typography:** Cinzel as the primary editorial/display font; Plus Jakarta Sans for body and UI
- **Deployment:** Vercel
...
- Preserve the approved palette: ivory cream `#F7F3EF`, charcoal rose accent `#3A3A3A` with white text, cocoa text `#432719`, dark cocoa `#321D16`, white `#FFFDF9`, and blush `#FBE9E5`.
