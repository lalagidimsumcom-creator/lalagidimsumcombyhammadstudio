...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F7F3EF] text-[#321D16] flex flex-col font-sans selection:bg-[#E75480] selection:text-white">
      <Navbar />
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-20 bg-[#F7F3EF] border-b border-[#FBE9E5] relative overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-8 text-center space-y-4">
          <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-[#FBE9E5] text-[#E75480] text-xs sm:text-sm font-bold uppercase tracking-wider">
            <Sparkle weight="fill" className="w-4 h-4 text-[#E75480]" />
              ...
              return (
                <button
                  ...
                  className={`px-6 py-2.5 rounded-full text-sm sm:text-base font-bold transition-all duration-300 ${
                    isActive
                      ? "bg-[#E75480] text-white shadow-md transform scale-105"
            ...
            >
              <div>
                ...
                <div className="relative w-full h-72 bg-[#F7F3EF] overflow-hidden">
                  ...
                  />
                  {product.badge && (
                    <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-bold text-[#E75480] shadow-sm border border-[#FBE9E5]">
                      {product.badge}
                    </div>
                  )}
                </div>
                ...
                <div className="p-7 space-y-4">
                  <div>
                    <h3 className="font-serif-display text-2xl font-bold text-[#321D16] group-hover:text-[#E75480] transition-colors">
                      {product.name}
                    </h3>
                  ...
                  <div className="space-y-1.5 pt-2 border-t border-[#FBE9E5]">
                    {product.highlights.map((h, idx) => (
                      <div key={idx} className="flex items-center text-xs sm:text-sm text-[#665750]">
                        <Check weight="bold" className="w-3.5 h-3.5 text-[#E75480] mr-2 shrink-0" />
                        <span>{h}</span>
                      </div>
                    ))}
                  </div>
              ...
              <div className="px-7 pb-7 pt-3 flex items-center justify-between border-t border-[#FBE9E5]/60">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-6 py-2.5 rounded-full text-sm font-bold bg-[#E75480] hover:bg-[#C7436D] text-white shadow-xs hover:shadow-md transition-all group-hover:scale-105"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="flex items-start space-x-4 p-5 rounded-2xl bg-white border border-[#FBE9E5] shadow-2xs">
              <div className="w-11 h-11 rounded-xl bg-[#FBE9E5] flex items-center justify-center shrink-0">
                <Truck weight="duotone" className="w-6 h-6 text-[#E75480]" />
              </div>
              <div>
            ...
            <div className="flex items-start space-x-4 p-5 rounded-2xl bg-white border border-[#FBE9E5] shadow-2xs">
              <div className="w-11 h-11 rounded-xl bg-[#FBE9E5] flex items-center justify-center shrink-0">
                <Snowflake weight="duotone" className="w-6 h-6 text-[#E75480]" />
              </div>
              <div>
            ...
            <div className="flex items-start space-x-4 p-5 rounded-2xl bg-white border border-[#FBE9E5] shadow-2xs">
              <div className="w-11 h-11 rounded-xl bg-[#FBE9E5] flex items-center justify-center shrink-0">
                <ShieldCheck weight="duotone" className="w-6 h-6 text-[#E75480]" />
              </div>
              <div>
      ...
      <section className="py-20 lg:py-28 max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 w-full">
        <div className="text-center mb-12 space-y-3">
          <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#FBE9E5] text-[#E75480] text-xs font-bold uppercase tracking-wider">
            <Question weight="duotone" className="w-4 h-4 text-[#E75480]" />
            ...
            return (
              <div
                ...
                className={`rounded-[24px] border transition-all ${
                  isOpen ? "bg-white border-[#E75480] shadow-md" : "bg-white/80 border-[#FBE9E5]"
                }`}
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${
                      isOpen ? "bg-[#E75480] text-white" : "bg-[#FBE9E5] text-[#E75480]"
                    }`}
                  >
        ...
        <div className="mt-12 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center space-x-2 px-9 py-4 rounded-full text-base font-bold bg-[#E75480] hover:bg-[#C7436D] text-white transition-colors shadow-md"
          >
