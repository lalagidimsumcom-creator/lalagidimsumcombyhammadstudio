...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#FAF7F8] text-[#3A2232] font-sans">
      <a
        href="#main-content"
        className="fixed left-4 top-4 z-[100] -translate-y-24 bg-[#E94E87] px-4 py-3 font-bold text-white transition-transform focus-visible:translate-y-0"
      >
        Lewati ke Konten
      </a>
      <EditorialNavbar />
