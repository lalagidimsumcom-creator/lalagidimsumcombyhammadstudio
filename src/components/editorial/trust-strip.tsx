        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-14">
          <div className="grid grid-cols-2 gap-7 sm:grid-cols-4 lg:col-span-7 lg:gap-6">
            ...
            <article className="flex flex-col items-center text-center">
              <div className="flex size-20 items-center justify-center rounded-2xl border border-white/25 bg-[#432719] shadow-[0_14px_35px_rgba(22,10,7,0.28)] transition-transform duration-200 hover:-translate-y-1 sm:size-24">
                <Medal weight="fill" className="size-10 text-white sm:size-12" aria-hidden="true" />
              </div>
              <strong className="mt-4 text-lg font-bold leading-tight text-white sm:text-xl">
                5+ Tahun
              </strong>
          ...
          <figure className="border-t border-white/15 pt-9 lg:col-span-5 lg:border-l lg:border-t-0 lg:pl-12 lg:pt-0">
            <Quotes weight="fill" className="size-10 text-white sm:size-12" aria-hidden="true" />
            ...
            <figcaption className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm font-semibold text-white/75">
              <span className="inline-flex items-center gap-2">
                ...
                <CheckCircle weight="fill" className="size-4 text-white" aria-hidden="true" />
              </span>
              <span className="inline-flex gap-0.5 text-white" aria-label="5 dari 5 bintang">
