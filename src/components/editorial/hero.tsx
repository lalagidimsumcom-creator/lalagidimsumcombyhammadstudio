...
export default function EditorialHero() {
  return (
    <section className="relative isolate overflow-hidden border-b border-[#EADDE5] bg-[#FAF7F8] md:min-h-[calc(100dvh-80px)] md:flex md:items-center lg:min-h-[720px]">
      <div className="hero-image-mask pointer-events-none absolute inset-y-0 right-0 hidden w-[62%] select-none md:block lg:w-[60%]">
        ...
        />
        <div className="absolute inset-y-0 left-0 w-[62%] bg-gradient-to-r from-[#FAF7F8] via-[#FAF7F8]/80 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#FAF7F8]/20 via-transparent to-[#FAF7F8]/10" />
      </div>
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1360px] px-6 pb-10 pt-16 sm:px-8 sm:pb-12 sm:pt-20 md:py-24 lg:px-12 lg:py-28 xl:px-16">
        <div className="max-w-[36rem] md:w-[46%]">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[#E94E87] sm:text-xs">
            Homemade <span aria-hidden="true">•</span> Halal <span aria-hidden="true">•</span> 90% Daging Ayam
          </p>
          <span aria-hidden="true" className="mt-6 block h-px w-10 bg-[#E94E87]" />
          ...
          <div className="mt-9 flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:gap-7">
            <a
              ...
              className="inline-flex min-h-13 w-full items-center justify-center gap-2.5 rounded-full bg-[#E94E87] px-7 py-3.5 text-sm font-semibold text-white shadow-[0_10px_28px_rgba(233,78,135,0.18)] transition-[transform,background-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:bg-[#D63D76] hover:shadow-[0_14px_34px_rgba(233,78,135,0.26)] active:translate-y-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#E94E87] sm:w-auto"
            >
            ...
            <Link
              href="/menu"
              className="group inline-flex min-h-11 items-center gap-2 border-b border-[#3A2232]/35 text-sm font-semibold text-[#3A2232] transition-colors duration-200 hover:border-[#E94E87] hover:text-[#E94E87] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#E94E87]"
            >
              Lihat Menu
      ...
      <div className="relative h-[31rem] w-full md:hidden">
        ...
        />
        <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-[#FAF7F8] to-transparent" />
      </div>
    </section>
  );
}
