    ...
    <section className="relative isolate overflow-hidden border-b border-[#EADDE5] bg-[#F7F3EF] md:min-h-[calc(100dvh-80px)] md:flex md:items-center lg:min-h-[720px]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1360px] px-6 pb-10 pt-16 sm:px-8 sm:pb-12 sm:pt-20 md:py-24 lg:px-12 lg:py-28 xl:px-16">
        <div className="max-w-[36rem] md:w-[46%]">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[#722F37] sm:text-xs">
            Homemade <span aria-hidden="true">•</span> Halal <span aria-hidden="true">•</span> 90% Daging Ayam
          </p>
          <span aria-hidden="true" className="mt-6 block h-px w-10 bg-[#722F37]" />
          ...
          <div className="mt-9 flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:gap-7">
            <a
              ...
              className="inline-flex min-h-13 w-full items-center justify-center gap-2.5 rounded-full bg-[#722F37] px-7 py-3.5 text-sm font-semibold text-white shadow-[0_10px_28px_rgba(114,47,55,0.18)] transition-[transform,background-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:bg-[#5F252D] hover:shadow-[0_14px_34px_rgba(114,47,55,0.26)] active:translate-y-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#722F37] sm:w-auto"
            >
            ...
            <Link
              href="/menu"
              className="group inline-flex min-h-11 items-center gap-2 border-b border-[#3A2232]/35 text-sm font-semibold text-[#3A2232] transition-colors duration-200 hover:border-[#722F37] hover:text-[#722F37] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#722F37]"
            >
              Lihat Menu
