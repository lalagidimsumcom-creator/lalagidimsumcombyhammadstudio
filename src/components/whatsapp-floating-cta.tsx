  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex size-14 items-center justify-center rounded-full border border-[#E75480] bg-[#E75480] text-white shadow-xl transition-[background-color,color,transform] duration-200 hover:-translate-y-1 hover:bg-[#D63D76] active:translate-y-0"
      >
