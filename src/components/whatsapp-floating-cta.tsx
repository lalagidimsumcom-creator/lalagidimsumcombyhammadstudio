  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex size-13 shrink-0 items-center justify-center rounded-full border border-[#25D366] bg-[#25D366] text-white shadow-xl transition-[background-color,color,transform] duration-200 hover:-translate-y-1 hover:bg-[#1FBF5B] active:translate-y-0 sm:size-14"
      >
